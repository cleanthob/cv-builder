            ...
            <Droppable droppableId={`droppable-${data.formKey}`}>
              {(provided) => (
                <div
                  ...
                  className="divide-y divide-border overflow-hidden rounded border border-border"
                >
                        ...
                        {(provided) => (
                          ...
                          >
                            <div
                              ...
                              className="h-full w-10 shrink-0 bg-muted/50 flex items-center justify-center hover:brightness-125 transition-all"
                            >
                              <GripVertical size={14} />
                            </div>

                            <div className="flex-1 flex flex-col justify-center px-3 cursor-pointer hover:bg-muted/80 transition-all">
                              <p className="font-bold font-title font-sm">
                                {String(field[titleKey] ?? "")}
                              </p>
                              <p className="text-xs text-muted-foreground">
                                {String(field[descriptionKey] ?? "")}
                              </p>
                            </div>
                          </div>
                        )}
